...
func (inst *InitVault) GetInitVaultAccounts() *InitVaultAccounts {
	...
	if inst.AccountMetaSlice[0] != nil {
		res.Creator = inst.AccountMetaSlice[0].PublicKey
	}
	...
	if inst.AccountMetaSlice[3] != nil {
		res.TokenAAccount = inst.AccountMetaSlice[3].PublicKey
	}
	if inst.AccountMetaSlice[4] != nil {
		res.TokenBAccount = inst.AccountMetaSlice[4].PublicKey
	}
	if inst.AccountMetaSlice[5] != nil {
		res.TreasuryTokenBAccount = inst.AccountMetaSlice[5].PublicKey
	}
